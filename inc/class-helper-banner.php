        ...
        <div class="uacf7-sidebar-promo">
            ...
            <div class="promo-description">
                ...
                <div class="dicount-timer">
                    ...
                    <a class="discount-btn" href="<?php echo esc_url($button_url) . '?ending=' . urlencode($end_time); ?>&utm_source=banner_uacf7&utm_medium=plugin_banner&utm_campaign=deal60" target="_blank" class="tf-btn tf-btn-primary">
