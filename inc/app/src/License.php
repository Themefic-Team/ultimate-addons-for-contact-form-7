        ...
        <div class="wrap appsero-license-settings-wrapper">
            ...
            <div class="appsero-license-settings appsero-license-section">
                ...
                <div class="appsero-license-details">
                    <p>
                        <?php wp_kses_post( sprintf( $this->client->__trans( 'Activate <strong>%s</strong> by your license key to get professional support and automatic update from your WordPress dashboard.' ), $this->client->name ) ); ?>
                    </p>
            ...
            <div class="single-license-info">
                ...
                <?php } else { ?>
                    <p class="<?php echo esc_attr( $license['remaining'] ? '' : 'occupied' ); ?>">
                        <?php wp_kses_post( sprintf( $this->client->__trans( '%1$d out of %2$d' ), $license['remaining'], $license['activation_limit'] ) ); ?>
                    </p>
                <?php } ?>
            </div>
            <div class="single-license-info">
