  	...
  	forms.each(function(){
        ...
        var formId = $(this).find('input[name="_wpcf7"]').val();
			...
			$(document).ready(function($){
				...
				var uacf7SelectedElementDateandSelect = $(`.uacf7-material-design-outlined .uacf7-form-${formId} .TFDate, .wpcf7-select, .TFFile`);
				var uacf7SelectedRequired             = $(`.uacf7-material-design-outlined .uacf7-form-${formId}`).attr('aria-required', 'true');
