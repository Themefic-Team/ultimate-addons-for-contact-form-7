...
class UACF7_FORM_PREVIEW{
    ...
    public function uacf7_form_preview_tag_handler_callback($tag){
        if (empty($tag->name)) {
          return '';
      }
    ...
    <?php 
      ...
      $form_preview_buffer = ob_get_clean();

      return $form_preview_buffer;
    }
                ...
                <tbody>
                      <div class="uacf7-doc-notice"> 
                          <?php echo sprintf( 
                              ...
                              '<a href="https://themefic.com/docs/uacf7/free-addons/form-preview/" target="_blank">documentation</a>'
                          ); ?> 
                      </div>
                      <tr>
