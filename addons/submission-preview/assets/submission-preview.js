...
jQuery(document).ready(function($) {
    $(document).on('click', '.uacf7-preview-btn', function(e) {
        ...
        formData.append('action', 'cf7_form_preview');
        formData.append('security', submission_preview.nonce);

        // Sending AJAX request
        $.ajax({
            url: submission_preview.ajaxurl,
            method: 'POST',
            // data: {
            //     action: 'cf7_form_preview',
            //     security: submission_preview.nonce,
            //     form_data: formData
            // },
            data: formData,
            processData: false,
            ...
            success: function(response) {
                ...
                var modalHTML = '<div class="uacf7-preview-modal"><div class="uacf7-preview-modal-content"><span class="uacf7-close-btn">&times;</span>' + response.data + '<div class="uacf7-modal-buttons"><button class="uacf7-back-btn"><i class="fas fa-undo"></i> Back</button><button class="uacf7-submit-btn">Submit <i class="far fa-paper-plane"></i></button></div></div>';
                $('body').append(modalHTML);
                $('.uacf7-preview-modal').fadeIn();
