				...
				<div class="uacf7-addons-settings-page">
					<div class="uacf7-addons-settings-page-wrapper">
						<h1 class="uacf7-setting-title">
							<?php echo _e( 'Addons for Contact Form 7 (UACF7) Settings', 'ultimate-addons-cf7' ) ?>
						</h1>
				...
				<div class="tf-settings-help-center">
					<div class="tf-help-center-banner">
						<div class="tf-help-center-content">
							...
							<p><?php _e( "Click the button below to run the setup wizard of Addons for Contact Form 7. Your existing settings will not change.", "ultimate-addons-cf7" ); ?>
							</p>
