			...
			apply_filters(
				...
				array(
					...
					'uacf7_load_cdn' => array(
						'title'  => __( 'Optimize Assets', 'ultimate-addons-for-contact-form-7' ),
						'parent' => 'uacf7_import_export_data',
						...
						'fields' => array(
							'uacf7_enable_cdn_load_css' => array(
								...
								'type'       => 'switch',
								'save_empty' => true,
								'label'      => __( 'Enable CSS Libraries Loading from CDN', 'ultimate-addons-for-contact-form-7' ),
								'subtitle'   => __( 'To optimize CSS performance, consider loading all assets from the CDN to reduce latency and enhance user experience.', 'ultimate-addons-for-contact-form-7' )
							...
							'uacf7_enable_cdn_load_js' => array(
								...
								'type'       => 'switch',
								'save_empty' => true,
								'label'      => __( 'Enable JavaScript Libraries Loading from CDN', 'ultimate-addons-for-contact-form-7' ),
								'subtitle'   => __( 'To maximize JavaScript performance, consider loading all assets from the CDN to reduce quiescence and faster user experience.', 'ultimate-addons-for-contact-form-7' )
