					...
					'general_addons' => array(
						...
						'fields' => array(
							...
							'uacf7_enable_redirection_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Redirection Pro (Conditional Redirect + Whatsapp Integration)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Conditional-Redirect2x.png',
								'subtitle'           => __( 'Redirect users to different webpages based on specific conditions. Supports CF7 fields tag and Whatsapp data transfer.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_conditional_field_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Conditional Field (Pro)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Conditional-Field2x.png',
								'subtitle'           => __( 'Advanced Conditional Logic for elements like Range Slider, Star Rating, Country Dropdown, and IP Geolocation.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_field_column_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Column - Custom Width', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Custom-Column-Width2x.png',
								'subtitle'           => __( 'Set form columns at custom / desired widths, like creating a form with columns of 12%, 27%, and 61% widths.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_uacf7style_global' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Form Styler (Global)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Global-Form-Styler.png',
								'default'            => false,
								'is_pro'             => true,
								'subtitle'           => __( 'Style all your forms from one place without any CSS code.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_multistep_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Multi-step Form (Pro)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Multi-Step-Form-Pro-Skins.png',
								'default'            => false,
								'subtitle'           => __( 'Choose from premium templates for multi-step forms, automatically generating pre-designed forms. ', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_booking_form' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Booking/Appointment (Legacy)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Booking-or-Appointment-Form2x.png',
								'default'            => false,
								'subtitle'           => __( 'Create a booking or appointment form using Contact Form 7, including calendar and time options, with payment support.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_drag_and_drop_file_upload' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Drag & Drop Multiple File Uploads', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/drag-and-drop.png',
								'default'            => false,
								'subtitle'           => __( 'The Drag & Drop File Upload addon brings a smooth and modern way for users to upload multiple files directly through your Contact Form 7 form.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_post_submission' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Frontend Post Submission', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Frontend-Post-Submission.png',
								'default'            => false,
								'subtitle'           => __( 'Automatically publish submitted forms as new posts and display them on the front end, with custom field support.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_form_submission_preview_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Form Preview Submission', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Frontend-Post-Submission.png',
								'default'            => false,
								'subtitle'           => __( 'Enable users to review and verify form data before final submission', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_save_and_continue_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Form Save & Continue', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Placeholder-Styling.png',
								'default'            => false,
								'subtitle'           => __( 'Increase Form Completion Rates With Save and Resume.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_google_captcha_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Google reCAPTCHA', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/google-recaptcha.png',
								'default'            => false,
								'subtitle'           => __( 'Safeguard your forms from spam, bot submissions, and malicious activity.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_google_sheet_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Google Sheets', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/google-spreadsheet.png',
								'default'            => false,
								'subtitle'           => __( 'Connect Contact Form 7 with Google Sheets to save form data automatically and make data entry easier.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_slack_integration' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Slack Integration', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Slack.png',
								'default'            => false,
								'subtitle'           => __( 'Connect Contact Form 7 with slack to get notifications.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_twilio_integration' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Twilio Integration', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Twilio.png',
								'default'            => false,
								'subtitle'           => __( 'Connect Contact Form 7 with Twilio to get notifications on your phone.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_prevent_duplicate_entries' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Prevent Duplicate Entries', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/prevent-duplicate-entries.png',
								'default'            => false,
								'subtitle'           => __( 'Prevent duplicate entries from being submitted.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_mailchimp_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Mailchimp Pro', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Connect-with-Mailchimp2x.png',
								'default'            => false,
								'subtitle'           => __( 'Integrate Contact Form 7 with Mailchimp. Add submissions to Mailchimp lists automatically', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_database_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Database Pro', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Save-to-Database.png',
								'default'            => false,
								'subtitle'           => __( 'Respond to inquiries from the dashboard and export submission data. It is an advanced solution for form inquiries. ', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_mailwkeely_pro' => array(
								'id' => 'uacf7_enable_mailwkeely_pro',
								  // 'child_field' => 'uacf7_enable_database_field',
								'type'               => 'switch',
								'label'              => __( 'Weekly Email Summary', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Save-to-Database.png',
								'default'            => false,
								'subtitle'           => __( 'Email Summaries provide daily or weekly reports with the number of entries for each of your forms.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_pdf_generator_field_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'PDF Generate Pro', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Send-PDF-Using-Contact-form-8.png',
								'default'            => false,
								'subtitle'           => __( "Download Generate PDFs after form submission. There will be a download button to download the submitted form.", 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_conversational_form' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Conversational Form', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Conversational-Form.png',
								'default'            => false,
								'subtitle'           => __( 'Create interactive, engaging forms that mimic a conversational experience. ', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_webhook_pro' => array(
								'id'                 => 'uacf7_enable_webhook_pro',
								'type'               => 'switch',
								'label'              => __( 'Pabbly/Zapier (Webhook) Pro', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Zapier-Webhook.png',
								'default'            => false,
								'subtitle'           => __( 'Transfer form data to third-party services like Pabbly or Zapier via webhooks. Supports conditional logic based on form fields. ', 'ultimate-addons-for-contact-form-7' ),
								'demo_link'          => 'https://cf7addons.com/preview/pabbly-zapier-webhook-pro/',
								'documentation_link' => 'https://themefic.com/docs/uacf7/pro-addons/contact-form-7-webhook-pro/',
								'is_pro'             => true
							),
							'uacf7_enable_salesforce_integration' => array(
								'id'                 => 'uacf7_enable_salesforce_integration',
								'type'               => 'switch',
								'label'              => __( 'Salesforce Integration', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Salesforce.png',
								'default'            => false,
								'subtitle'           => __( 'Integrate with Salesforce to save form entries as leads and contacts', 'ultimate-addons-for-contact-form-7' ),
					...
					'extra_fields_addons' => array(
						...
						'fields' => array(
							...
							'uacf7_enable_star_rating_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Star Rating Field (Pro)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Star-Rating-Field-Pro.png',
								'default'            => false,
								'subtitle'           => __( "Choose from 5 built-in Star Rating styles, or use any Font Awesome icon for custom styles. ", 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_range_slider_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Range Slider (Pro)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Range-Slider-Pro.png',
								'default'            => false,
								'subtitle'           => __( 'Choose from 3 premium pre-built Range Slider layouts for Contact Form 7. ', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_repeater_field' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Repeater Field', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Repeater-Field.png',
								'default'            => false,
								'subtitle'           => __( 'Add a repeater field to Contact Form 7 to repeat various fields, like text, files, checkboxes, text-areas, etc., with mail tag support.', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_ip_geo_fields' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'IP Geo Fields (Autocomplete Country, City, State, Zip Fields)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/IP-Geolocation.png',
								'default'            => false,
								'subtitle'           => __( 'Set up IP Geolocation-based Auto Completion for Country, City, State, Zip Fields. ', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_spam_protection_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'Spam Protection (Pro)', 'ultimate-addons-for-contact-form-7' ),
								'label_on'           => __( 'Yes', 'ultimate-addons-for-contact-form-7' ),
								'label_off'          => __( 'No', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/spam_protection.png',
								'default'            => false,
								'subtitle'           => __( 'The pro features guarantee highly effective methods to prevent spam form submissions on your website, enhancing security and reliability.', 'ultimate-addons-for-contact-form-7' ),
					...
					'wooCommerce_integration' => array(
						...
						'fields' => array(
							...
							'uacf7_enable_product_dropdown_pro' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'WooCommerce Product Dropdown (Pro)', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/Woo-Categorized-Product.png',
								'default'            => false,
								'is_pro'             => true,
								'subtitle'           => __( 'Add specific WooCommerce products as dropdowns based on Product ID, with options to connect to Cart/Checkout and show products based on categories or IDs. ', 'ultimate-addons-for-contact-form-7' ),
							...
							'uacf7_enable_product_auto_cart' => array(
								...
								'type'               => 'switch',
								'label'              => __( 'WooCommerce Checkout', 'ultimate-addons-for-contact-form-7' ),
								'image_url'          => UACF7_URL . 'assets/admin/images/addons/WooCommerce-Checkout.png',
								'default'            => false,
								'subtitle'           => __( 'Connect your form with WooCommerce. The process: The user selects a product from the dropdown field, submits the form, and is then automatically redirected to the WooCommerce Cart page with the product added to their cart.', 'ultimate-addons-for-contact-form-7' ),
