...
if ( ! class_exists( 'UACF7_image' ) ) {
	class UACF7_image extends UACF7_Fields {
		...
		public function render() {
			...
			<input type="text" name="' . esc_attr( $this->field_name() ) . '" id="' . esc_attr( $this->field_name() ) . '" value="' . $this->value . '" disabled="disabled" /><a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-media-upload button button-primary button-large">' . esc_html( "Upload","ultimate-addons-for-contact-form-7" ) . '</a></div>
