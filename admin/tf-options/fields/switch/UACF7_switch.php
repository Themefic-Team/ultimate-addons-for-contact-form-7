	...
	class UACF7_switch extends UACF7_Fields {
		...
		public function render() {
            ...
            <label for="<?php echo esc_attr( $this->field_name() ); ?>" class="tf-switch-label" <?php echo wp_kses_post($width); ?>>
                <input type="checkbox" id="<?php echo esc_attr( $this->field_name() ); ?>" name="<?php echo esc_attr( $this->field_name() ); ?>" value="<?php echo esc_attr($this->value); ?>" data-depend-id="<?php echo esc_attr( $this->field['id'] ); ?><?php echo esc_attr($this->parent_field); ?>" class="tf-switch" <?php checked( $this->value, 1 ); ?> <?php echo wp_kses_post( $this->field_attributes() ) ?>/>
