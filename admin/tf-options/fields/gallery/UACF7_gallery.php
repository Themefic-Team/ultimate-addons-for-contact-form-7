...
if ( ! class_exists( 'UACF7_gallery' ) ) {
	class UACF7_gallery extends UACF7_Fields {
		...
		public function render() {
			...
			<a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-upload button button-primary button-large">' . esc_html( __("Add Gallery","ultimate-addons-cf7") ) . '</a>';
			if(!empty($this->value)){
				echo '<a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-edit button button-primary button-large ' . esc_attr(str_replace(array("[","]","-"),"_",esc_attr( $this->field_name() ) ) ). '">' . esc_html( "Edit Gallery","ultimate-addons-cf7" ) . '</a><a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-remove button button-warning button-large ' . esc_attr(str_replace(array("[","]","-"),"_",esc_attr( $this->field_name() ) ) ) . '" style="display:inline-block">' . esc_html( "Clear","ultimate-addons-cf7" ) . '</a>';
			}else{
