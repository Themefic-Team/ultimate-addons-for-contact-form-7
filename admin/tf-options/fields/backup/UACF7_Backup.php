...
if ( ! class_exists( 'UACF7_Backup' ) ) {
	class UACF7_Backup extends UACF7_Fields {
		...
		public function render() {
			...
			echo '<a class="tf-export-button tf-admin-btn tf-btn-secondary">' . __( 'Copy', 'ultimate-addons-for-contact-form-7' ) . '</a>';
			echo '</div>';
			echo '<hr>';
			...
			// echo '<a href="#" class="tf-import-btn button button-primary">' . __( 'Import', 'ultimate-addons-for-contact-form-7' ) . '</a>';
			echo '<button type="submit" class="tf-import-btn tf-admin-btn tf-btn-secondary" data-option="' . esc_attr( $this->settings_id ) . '" data-submit-type="tf_import_data">' . __( 'Import', 'ultimate-addons-for-contact-form-7' ) . '</button>';
